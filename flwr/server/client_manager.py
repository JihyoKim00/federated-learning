...
class SimpleClientManager(ClientManager):
    ...
    def sample(
        ...
        available_cids_len = len(available_cids)

        # Make a dictionary 

        cid_dict = dict(zip(available_cids, np.arange(available_cids_len)))
        ...
        return [self.clients[cid] for cid in sampled_cids], cid_dict, sampled_cids
